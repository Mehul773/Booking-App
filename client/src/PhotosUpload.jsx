...
export default function PhotosUploader({
  ...
  //if user click on delete icon this img should be delete
          ...
          addedPhotos.map((link) => (
            <div key={link} className="relative">
              ...
              <button
                ...
                className="absolute cursor-pointer bottom-2 right-2 hover:text-primary text-white bg-black opacity-70 rounded-3xl p-1 "
              >
                <svg
              ...
              <button
                ...
                className="absolute cursor-pointer bottom-2 left-2 hover:text-primary text-white bg-black opacity-70 rounded-3xl p-1 "
              >
                {link === addedPhotos[0] && (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
